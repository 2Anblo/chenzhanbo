...
export default function BlogPostPage({ post }: BlogPostPageProps) {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 px-6 py-24 xl:grid-cols-[minmax(0,48rem)_16rem] xl:items-start">
        <main className="mx-auto w-full min-w-0 max-w-3xl xl:mx-0 xl:max-w-none xl:justify-self-start">
          {/* Back Link */}
          <Link
            href="/"
